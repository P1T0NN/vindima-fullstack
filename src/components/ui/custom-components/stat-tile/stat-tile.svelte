	...
	{#if delta}
		...
		>
			{#if delta.direction === 'up'}
				<span class="icon-[lucide--arrow-up-right] size-3.5" aria-hidden="true" ></span>
			{:else if delta.direction === 'down'}
				<span class="icon-[lucide--arrow-down-right] size-3.5" aria-hidden="true" ></span>
			{:else}
				<span class="icon-[lucide--minus] size-3.5" aria-hidden="true" ></span>
			{/if}
			{delta.text}
		</span>
	{/if}
