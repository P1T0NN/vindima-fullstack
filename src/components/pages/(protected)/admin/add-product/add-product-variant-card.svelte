<script lang="ts">
	...
	// TYPES
	import type { CreateProductVariantInput } from '@/shared/features/products/schemas/productsSchemas';
...
<Card class="gap-3 rounded-lg p-3 shadow-none">
	<div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
		<Field>
			...
			<Input id="ref-{index}" bind:value={variant.ref} placeholder="boards-1-M" />
		</Field>
