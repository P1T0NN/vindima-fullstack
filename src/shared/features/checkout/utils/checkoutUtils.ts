...
/**
 * Collapse lifecycle status and fulfillment into the single badge the account UI
 ...
 *
 * Unpaid online orders carry either `draft` (current flow) or `pending` (legacy rows). Once
 * settled, the fulfillment stage takes over.
 */
